...
const SignupPage = () => {
  ...
  const onSubmit = async (formData) => {
    try {
      ...
      window.location = "/"; //used navigate before but we wanted a reload
    } catch (err) {
  ...
  //this below function below is used for rare cases
  //like a logged-in user trying to access the signup page
  //must be re-directed to homepage
  if (getUser()) {
    return <Navigate to="/" />;
  }
